...
export class PlaceDetailComponent implements OnInit {
  ...
  // ✅ Catégories alignées avec les valeurs Firestore : Restaurant, Fruits de mer, etc.
...
echo "✅ Fix appliqué : catégories alignées (Restaurant, Fruits de mer, etc.)."
